...
pragma Priority_Specific_Dispatching(FIFO_Within_Priorities, 4, 30);
pragma Priority_Specific_Dispatching(Round_Robin_Within_Priorities, 1, 3);
--explain robin
...
procedure PeriodicTasks_Priority is
   ...
   Task_1 : T(1, 10, Warm_Up_Time, 300, 100, 300);  --100,300,100,300
   Task_2 : T(2, 9, Warm_Up_Time, 400, 100, 400);  --100,400,100,400
   Task_3 : T(3, 8, Warm_Up_Time, 600, 100, 600);  --100,600,100,600
 --Round_Robin -prio(1,3)
   Task_back1 : T(4, 3, Warm_Up_Time, 1200, 100, 1200);  
   Task_back2 : T(5, 3, Warm_Up_Time, 1200, 100, 1200);  
   Task_back3 : T(6, 1, Warm_Up_Time, 1200, 100, 1200);  --then T6 will never be run
