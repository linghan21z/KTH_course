...
procedure PeriodicTasks_Priority is
   ...
   Start : Time; -- Start Time of the System
	Calibrator: constant Integer := 1000; -- Calibration for correct timing
	                                     -- ==> Change parameter for your architecture! --original 850
   ...
   Task_1 : T(1, 4, Warm_Up_Time, 300, 100, 300);  --100,300,100,300
   Task_2 : T(2, 3, Warm_Up_Time, 400, 100, 400);  --100,400,100,400
   Task_3 : T(3, 2, Warm_Up_Time, 600, 100, 600);  --100,600,100,600
   Task_4 : T(4, 1, Warm_Up_Time, 1200, 200, 1200); --100，1200，200，1200
